...
DET_PATH = '../../data/myMotData/test'
ANN_PATH = '../../data/myMotData/annotations/{}.json'.format(split)
OUT_DIR = '../../data/myMotData/results/'
...
if __name__ == '__main__':
  if not os.path.exists(OUT_DIR):
    os.mkdir(OUT_DIR)
  # seqs = [s for s in os.listdir(DET_PATH) if 'det' in s]
  seqs = [s for s in os.listdir(DET_PATH)]
  # print(os.listdir(DET_PATH))
  ...
  for seq in sorted(seqs):
    ...
    for i in range(len(anns)):
      ...
      file_name = '{}/img1/frame_{}.png'.format(seq, frame_id + frame_base)
